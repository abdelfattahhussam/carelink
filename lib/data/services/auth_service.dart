...
class AuthService {
  ...
  Future<UserModel> register({
    ...
    throw ServerFailure(message: response.data['error'] ?? 'Registration failed');
  }
  ...
  Future<UserModel> updateProfile({
    ...
    throw ServerFailure(message: response.data['error'] ?? 'Profile update failed');
  }
  ...
  Future<UserModel> getProfile() async {
    ...
    throw ServerFailure(message: response.data['error'] ?? 'Failed to get profile');
  }
}
