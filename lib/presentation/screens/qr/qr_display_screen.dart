            ...
            TextButton.icon(
              onPressed: () async {
                if (itemId != null && itemType != null) {
                  ...
                  qrBloc.add(QrConfirmProcessed(id: itemId!, type: itemType!));
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Simulation error: Missing ID or Type')),
                  );
                }
              },
              icon: const Icon(Icons.bug_report_rounded, size: 18),
              label: const Text('DEBUG: Simulate Pharmacist Scan', style: TextStyle(fontWeight: FontWeight.w700)),
