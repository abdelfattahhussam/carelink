...
class _RequestScreenState extends State<RequestScreen> {
  ...
  void _submit() {
    ...
    if (_prescriptionImage == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(AppLocalizations.of(context)!.attachPrescription),
          backgroundColor: AppColors.error,
        ),
      );
      return;
    ...
    if (_reasonCtrl.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            '${AppLocalizations.of(context)!.notesForPharmacist} is required',
          ),
          backgroundColor: AppColors.error,
        ),
      );
    ...
    context.read<RequestBloc>().add(
      RequestCreateRequested(
        ...
        prescriptionPath: _prescriptionImage?.path,
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<RequestBloc, RequestState>(
      ...
      child: Scaffold(
        ...
        body: med == null
            ? Center(
                child: Text(AppLocalizations.of(context)!.medicineNotFound),
              )
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color:
                              (med.isExpired ? AppColors.error : AppColors.info)
                          ...
                          children: [
                            ...
                            Text(
                              AppLocalizations.of(context)!.expiresAt(
                                DateFormatters.formatDate(med.expiryDate),
                                med.daysUntilExpiry.toString(),
                              ),
                              style: TextStyle(
                                fontSize: 12,
                                color: med.isExpired
                      ...
                      if (!med.inStock) ...[
                        ...
                        Container(
                          ...
                          child: SwitchListTile(
                            ...
                            title: Text(
                              AppLocalizations.of(context)!.markAsUrgent,
                              style: const TextStyle(
                                fontWeight: FontWeight.w500,
                              ),
                            ),
